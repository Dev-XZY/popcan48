...
用爱发电的小工具。主要是为了解决口袋48翻牌不好找、不好存的问题。
顺便接入了大模型，把历史翻牌喂给 AI，让它模仿你推的语气陪你聊天，亲测还原度不错，仅供娱乐。

## 功能一览

* **⚡️ 翻牌备份**：登录账号后，一键拉取账号下所有历史翻牌，永久保存。
...
* **数据安全**：账号和翻牌数据仅在本地处理，不会上传任何第三方服务器。
* **关于 AI**：AI 对话需要调用大模型接口，对话内容会发送给服务商，请知悉。
* **免责**：本项目仅供技术交流和个人收藏使用，请勿用于商业用途。
